...
<head>
  ...
  <title>petugas - DaftarBuku</title>
 <!-- plugins:css -->
  ...
  <link rel="stylesheet" type="text/css" href="<?= base_url() ?>css/petugas/tambahBuku.css">
  <!-- endinject -->
				...
				<div class="col-lg-8 grid-margin stretch-card tambah">
					<div class="card">
						<div class="card-body">
							...
							<form method="post" action="<?= site_url('petugas/tambahBuku') ?>" enctype="multipart/form-data">
								<div class="mb-3">
				...
				<div class="col-lg-8 grid-margin stretch-card">
					<div class="card">
						<div class="card-body">
							...
							<form method="post" action="<?= site_url('petugas/editBuku/' . $item['BukuID']); ?>">
								<div class="mb-3">
									<label for="judul-buku" class="form-label">Judul</label>
                    ...
                    <?php endforeach; ?>
								...
								<div class="mb-3">
									<label for="stok" class="form-label">Stok Buku</label>
									<input type="text" class="form-control" name="stok" id="stok" value="<?= $item['stok']; ?>">
								</div>
  ...
  <script type="text/javascript">
  	function hapusBuku(BukuID) {
        if (confirm('Apakah Anda yakin ingin menghapus buku ini?')) {
            window.location.href = `<?= site_url('petugas/hapusBuku/') ?>${BukuID}`;
        }
    }
  </script>
 <!-- plugins:js -->
