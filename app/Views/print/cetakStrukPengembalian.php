    ...
    <div id="bot">
      <div id="table">
            <table>
                ...
                <tr class="service">
                    <td class="tableitem"><p class="itemtext"><?= $Judul ?></p></td>
                    <td class="tableitem"><p class="itemtext"><?= $total_pinjam ?></p></td>
                    <td class="tableitem"><p class="itemtext"><?= $total_denda ?></p></td>
                </tr>
                <tr class="tabletitle">
                    <!-- <td></td> -->
                    <td class="Rate"><h2>Total Dibayarkan</h2></td>
                    <td class="payment"><h2>Rp. <?= $UangDibayarkan ?></h2></td>
                </tr>
                <tr class="tabletitle">
                    <!-- <td></td> -->
                    <td class="Rate"><h2>Uang Kembalian</h2></td>
                    <td class="payment"><h2>Rp. <?= $UangKembalian ?></h2></td>
                </tr>
