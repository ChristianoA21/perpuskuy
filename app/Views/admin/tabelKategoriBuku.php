...
<head>
  ...
  <title>Admin - KategoriBuku</title>
 <!-- plugins:css -->
  ...
  <link rel="stylesheet" type="text/css" href="<?= base_url() ?>css/admin/tambahKategori.css">
  <!-- endinject -->
				...
				<div class="col-lg-8 grid-margin stretch-card tambah">
					<div class="card">
						<div class="card-body">
							...
							<form method="post" action="<?= site_url('admin/tambahKategori') ?>" enctype="multipart/form-data">
								<div class="mb-3">
				...
				<div class="col-lg-8 grid-margin stretch-card">
					<div class="card">
						<div class="card-body">
							...
							<form method="post" action="<?= site_url('admin/editKategori/' . $item['KategoriID']); ?>">
								<div class="mb-3">
									<label for="KategoriID" class="form-label">Kategori Id</label>
  ...
  <script type="text/javascript">
  	function hapusKategori(KategoriID) {
        if (confirm('Apakah Anda yakin ingin menghapus kategori ini?')) {
            window.location.href = `<?= site_url('admin/hapusKategori/') ?>${KategoriID}`;
        }
    }
  </script>
 <!-- plugins:js -->
