                ...
                <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                  ...
                  <div>
                    <div class="btn-wrapper">
                      <a href="<?= base_url('admin/dashboard/pdf/generate') ?>" class="btn btn-primary text-white me-0"><i class="icon-printer"></i> Print</a>
                    </div>
                  </div>
                </div>
                      ...
                      <div class="col-sm-12">
                        <div class="statistics-details d-flex align-items-center justify-content-between">
                          ...
                          <div>
                            ...
                            <h3 class="rate-percentage"><?= count($petugas); ?></h3>
                          </div>
